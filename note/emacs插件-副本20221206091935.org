...
* mmm mode
mmm mode是emacs的一个minor mode，它允许多个major mode 存在于一个buffer中，它适用于以下的编辑环境：
  - 预处理代码，例如嵌入在html中的服务器端ruby、perl或php代码；
  - 代码生成代码，例如cgi脚本的html输出；
  - 嵌入代码，例如html中的javascript
  - 文学编程，散布在文档中的代码，例如Noweb
* avy
